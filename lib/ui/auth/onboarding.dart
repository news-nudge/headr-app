...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Widget buildRespectiveBackground() {
    if(_valueNotifier.value==360){
      return Image.asset(onboarding4,width: 100.w,height: 100.h,fit: BoxFit.cover,);
    }else if(_valueNotifier.value==90){
      return Image.asset(onboarding1,width: 100.w,height: 100.h,fit: BoxFit.cover,);
    }else if(_valueNotifier.value == 180){
      return Image.asset(onboarding2,width: 100.w,height: 100.h,fit: BoxFit.cover,);
    }else{
      return Image.asset(onboarding3,width: 100.w,height: 100.h,fit: BoxFit.cover,);
    }
    setState(() {});
  }
}